...
def load_ion_yaml() -> dict:
    return load_yaml(REPO_ROOT / "schema/core/v2/api/v2.0.0/ion.yaml")
            ...
            "catalog": {
                ...
                "offers": [{
                    ...
                    "offerAttributes": {
                        ...
                        "cancellationPolicy": "ion://policy/cancellation.trade.standard-v1",
                        "returnPolicy": "ion://policy/return.trade.standard-v1",
                        "warrantyPolicy": "ion://policy/warranty.trade.manufacturer-v1",
                        "disputePolicy": "ion://policy/dispute.trade.standard-v1",
                        "returnable": True,
                        "timeToShip": "<PT24H>",
                        "availableOnCod": "COD" in payment,
