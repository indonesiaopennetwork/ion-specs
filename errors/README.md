...
- code: ION-3001                          # Unique code — never reuse
  ...
  affected_apis:
    - select
  schema_ref: schema/extensions/trade/resource/v1  # Repo-relative path, or null
...
jq '[.[] | select(.schema_ref == "schema/extensions/trade/resource/v1")]' errors/registry.json
