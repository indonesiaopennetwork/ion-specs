# trade/performance-states

Canonical state machine definitions for trade fulfilment — states, allowed transitions, dwell durations, SLA breach thresholds. Machine-readable; not a Beckn attachment.

**Attaches to:** `Canonical enum — no attachment`  
