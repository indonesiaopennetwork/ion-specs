# ION Logistics Tracking Extension (v1) — Overview

**Pack:** `logistics/tracking/v1`  
**Sector:** Logistics  
**Version:** v1  

## Purpose

ION Logistics Tracking Extension (v1) defines the ION extension attributes for the `tracking` slot in the logistics sector. See `attributes.yaml` for the full property catalogue and `vocab.jsonld` for the JSON-LD vocabulary.
