# ION Logistics Resource Extension (v1) — Overview

**Pack:** `logistics/resource/v1`  
**Sector:** Logistics  
**Version:** v1  

## Purpose

ION Logistics Resource Extension (v1) defines the ION extension attributes for the `resource` slot in the logistics sector. See `attributes.yaml` for the full property catalogue and `vocab.jsonld` for the JSON-LD vocabulary.
