# ION Logistics Agent Extension (v1) — Overview
...
ION Logistics Agent Extension (v1) defines the ION extension attributes for the `participant-logistics` slot in the logistics sector. See `attributes.yaml` for the full property catalogue and `vocab.jsonld` for the JSON-LD vocabulary.
