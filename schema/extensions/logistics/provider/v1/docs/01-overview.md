# ION Logistics Provider Extension (v1) — Overview

**Pack:** `logistics/provider/v1`  
**Sector:** Logistics  
**Version:** v1  

## Purpose

ION Logistics Provider Extension (v1) defines the ION extension attributes for the `provider` slot in the logistics sector. See `attributes.yaml` for the full property catalogue and `vocab.jsonld` for the JSON-LD vocabulary.
