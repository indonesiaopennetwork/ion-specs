# ION Logistics Contract Extension (v1) — Overview

**Pack:** `logistics/contract/v1`  
**Sector:** Logistics  
**Version:** v1  

## Purpose

ION Logistics Contract Extension (v1) defines the ION extension attributes for the `contract` slot in the logistics sector. See `attributes.yaml` for the full property catalogue and `vocab.jsonld` for the JSON-LD vocabulary.
