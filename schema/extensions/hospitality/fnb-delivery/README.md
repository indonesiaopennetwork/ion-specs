# hospitality/fnb-delivery

ION Hospitality sector attribute pack for prepared food and beverage delivery.

**Attachment:** `Resource.resourceAttributes` — see `v1/profile.json`
