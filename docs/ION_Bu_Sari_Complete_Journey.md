...
*ION hierarchy layers engaged: Organisation · Role · Profile · Sector · Segment · CRC · Resource*
      ...
      "commitments": [
        {
          ...
          "commitmentAttributes": {
            "@context": "https://schema.ion.id/releases/release1/extension/trade/TradeCommitment/v1/context.jsonld",
      ...
      "considerations": [
        {
          ...
          "considerationAttributes": {
            "@context": "https://schema.ion.id/releases/release1/extension/trade/TradeConsideration/v1/context.jsonld",
...
```json
{
  "contract": {
    ...
    "status": "ACTIVE",
    "contractAttributes": {
      "@context": "https://schema.ion.id/releases/release1/extension/trade/TradeContract/v1/context.jsonld",
